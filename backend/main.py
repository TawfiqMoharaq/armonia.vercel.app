...
SYSTEM_PROMPT = (
    ...
    "رد باختصار ووضوح بدون تكرار. لا تكتب تمرين السكوات داخل نص ui_text إذا تم تضمينه في payload.\n\n"

    "🟦 تنسيق الرد مطلوب:\n"
    "1)  إحماء بسيط خطوة واحدة\n"
    "2)  تمرين رئيسي موجود فقط داخل payload\n"
    "3)  تمرين استطالة واحد بعده\n"
    "4)  نصائح سلامة قصيرة\n\n"

    "مهم جدًا:\n"
    "• ui_text يكون فقط كلام بدون اسم التمرين والتكرارات.\n"
    "• تمرين السكوات أو أي تمرين رئيسي وتفاصيله تكون داخل payload فقط.\n"
    "• لا تكرر التمرين داخل ui_text إذا موجود في payload.\n"
    "• لا تضع JSON داخل ui_text نهائيًا.\n\n"

    'أعد دائمًا إخراجك بداخل JSON فقط هكذا:\n'
    '{\n'
    '  "ui_text": "نص عربي منسق (Markdown مسموح) بدون أسماء التمرين داخل النص",\n'
    '  "payload": {\n'
    '     "exercise": "اسم التمرين",\n'
    '     "reps": "المدة/التكرارات",\n'
